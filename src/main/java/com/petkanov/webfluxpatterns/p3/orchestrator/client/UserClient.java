...
import com.petkanov.webfluxpatterns.p3.orchestrator.dto.PaymentRequest;
import com.petkanov.webfluxpatterns.p3.orchestrator.dto.PaymentResponse;
...
public class UserClient {
    ...
    public UserClient(@Value("${orchestrator.user.service}") String baseUrl){
